...
class Data_Loader():
    ...
    def preprocessing(self):
        # Initialize X_train with shape [samples, joints * channels]
        ...
        if not set(unique_labels).issubset({0, 1}):
            # If labels are not binary, binarize them
            # Define your binarization logic based on your dataset
            # Example: Assume any label >0 is 1, else 0
        ...
        # Slice X_train and y_train to include only full sequences
        ...
        # Assign a single label per sequence, e.g., the label of the last timestep
        # y_train = y_train[:, -1]
