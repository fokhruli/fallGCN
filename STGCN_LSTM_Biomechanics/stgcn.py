...
class SGCN_LSTM_Fused(nn.Module):
    def __init__(self, adj_matrix, adj_matrix2, adj_matrix3, input_shape, biomech_dim=44, device='cuda'):
        ...
        self.biomech_lstm1 = nn.LSTM(
            input_size=44,  # Input from CNN output
    ...
    def forward(self, pose_data, biomech_data):
        ...
        fused_features = torch.cat([stgcn_features2, fused_features_scaled], dim=1)  # [batch, 160]
